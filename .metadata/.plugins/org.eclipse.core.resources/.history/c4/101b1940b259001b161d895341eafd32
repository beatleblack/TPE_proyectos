/**
 * GetTemperature2020ResponseType9.java
 *
...
public class GetTemperature2020ResponseType9  implements java.io.Serializable {
    private org.tempuri.ArrResultAgilController getTemperature2020Result;

    public GetTemperature2020ResponseType9() {
    }
    ...
    /**
     * Gets the getTemperature2020Result value for this GetTemperature2020ResponseType9.
     * 
    ...
    /**
     * Sets the getTemperature2020Result value for this GetTemperature2020ResponseType9.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetTemperature2020ResponseType9)) return false;
        GetTemperature2020ResponseType9 other = (GetTemperature2020ResponseType9) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetTemperature2020ResponseType9.class, true);
