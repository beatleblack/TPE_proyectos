...
public class GetSiteHealthInfo2020  implements java.io.Serializable {
    private java.lang.String strIdCustomer;

    public GetSiteHealthInfo2020() {
    }
    ...
    /**
     * Gets the strIdCustomer value for this GetSiteHealthInfo2020.
     * 
    ...
    /**
     * Sets the strIdCustomer value for this GetSiteHealthInfo2020.
     * 
     * @param strIdCustomer
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSiteHealthInfo2020)) return false;
        GetSiteHealthInfo2020 other = (GetSiteHealthInfo2020) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSiteHealthInfo2020.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">getSiteHealthInfo2020"));
