/**
 * GetMemoryDevice2020ResponseType2.java
 *
...
public class GetMemoryDevice2020ResponseType2  implements java.io.Serializable {
    private org.tempuri.ArrResultAgilController getMemoryDevice2020Result;

    public GetMemoryDevice2020ResponseType2() {
    }
    ...
    /**
     * Gets the getMemoryDevice2020Result value for this GetMemoryDevice2020ResponseType2.
     * 
    ...
    /**
     * Sets the getMemoryDevice2020Result value for this GetMemoryDevice2020ResponseType2.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetMemoryDevice2020ResponseType2)) return false;
        GetMemoryDevice2020ResponseType2 other = (GetMemoryDevice2020ResponseType2) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetMemoryDevice2020ResponseType2.class, true);
