...
public class OutBpspacket  implements java.io.Serializable {
    ...
    /**
     * Gets the upwardSpeed value for this OutBpspacket.
     * 
     * @return upwardSpeed
     */
    ...
    /**
     * Sets the upwardSpeed value for this OutBpspacket.
     * 
     * @param upwardSpeed
     */
    ...
    /**
     * Gets the downwardSpeed value for this OutBpspacket.
     * 
    ...
    /**
     * Sets the downwardSpeed value for this OutBpspacket.
     * 
     * @param downwardSpeed
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OutBpspacket)) return false;
        OutBpspacket other = (OutBpspacket) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OutBpspacket.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", "OutBpspacket"));
