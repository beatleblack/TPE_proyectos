...
public class GetAlarmDevice2020  implements java.io.Serializable {
    private java.lang.String strIdCustomer;

    public GetAlarmDevice2020() {
    }
    ...
    /**
     * Gets the strIdCustomer value for this GetAlarmDevice2020.
     * 
    ...
    /**
     * Sets the strIdCustomer value for this GetAlarmDevice2020.
     * 
     * @param strIdCustomer
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetAlarmDevice2020)) return false;
        GetAlarmDevice2020 other = (GetAlarmDevice2020) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAlarmDevice2020.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetAlarmDevice2020"));
