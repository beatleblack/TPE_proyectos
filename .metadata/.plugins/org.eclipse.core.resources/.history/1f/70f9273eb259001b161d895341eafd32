...
public class GetInfoQoS  implements java.io.Serializable {
    ...
    /**
     * Gets the strIdCustomer value for this GetInfoQoS.
     * 
    ...
    /**
     * Sets the strIdCustomer value for this GetInfoQoS.
     * 
     * @param strIdCustomer
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetInfoQoS)) return false;
        GetInfoQoS other = (GetInfoQoS) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetInfoQoS.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">GetInfoQoS"));
