/**
 * GetDiskSpaceUsage2020ResponseType1.java
 *
...
public class GetDiskSpaceUsage2020ResponseType1  implements java.io.Serializable {
    private org.tempuri.ArrResultAgilController getDiskSpaceUsage2020Result;

    public GetDiskSpaceUsage2020ResponseType1() {
    }
    ...
    /**
     * Gets the getDiskSpaceUsage2020Result value for this GetDiskSpaceUsage2020ResponseType1.
     * 
    ...
    /**
     * Sets the getDiskSpaceUsage2020Result value for this GetDiskSpaceUsage2020ResponseType1.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetDiskSpaceUsage2020ResponseType1)) return false;
        GetDiskSpaceUsage2020ResponseType1 other = (GetDiskSpaceUsage2020ResponseType1) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetDiskSpaceUsage2020ResponseType1.class, true);
